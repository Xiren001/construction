                ...
                <div class="signin-content">
                    <div class="signin-form">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="register-form" id="login-form">
                            @csrf
                            <div class="form-group" style="margin-bottom: 1rem; margin-top: 3rem;">
                                <div class="ico">
                                    ...
                                    <x-text-input class="group" id="email" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Email" />
                                </div>
                            </div>
                    ...
                    <div class="signin-image">
                        <figure>
                            <img src="{{ asset('assets/image/logo-c.png') }}" alt="sign in image">
                        </figure>
