<nav x-data="{ open: false }" class="border-b border-gray-100 dark:border-gray-100 p-2" style="background-color: #0A3247;">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('completed_works.index')" :active="request()->routeIs('completed_works.index')">
                    {{ __('Completed Work') }}
                </x-responsive-nav-link>
            @endif
        </div>
