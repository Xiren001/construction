<x-app-layout>
                    ...
                    <table class="table-auto w-full text-center border-collapse whitespace-nowrap table-striped">
                        <thead>
                            <tr tabindex="0" class="focus:outline-none h-10 border border-gray-100 rounded">
                                <th class="py-2 border-b-2 border-gray-200">
                                    <a href="{{ route('client.index', ['sort_by' => 'name', 'sort_direction' => request('sort_direction') === 'asc' && request('sort_by') === 'name' ? 'desc' : 'asc']) }}" class="text-blue-600 hover:text-blue-800">
                                        Name
                                ...
                                <th class="py-2 border-b-2 border-gray-200">
                                    <a href="{{ route('client.index', ['sort_by' => 'email', 'sort_direction' => request('sort_direction') === 'asc' && request('sort_by') === 'email' ? 'desc' : 'asc']) }}" class="text-blue-600 hover:text-blue-800">
                                        Email
                                ...
                                <th class="py-2 border-b-2 border-gray-200">Phone</th>
                        ...
                        <tbody>
                            ...
                            <tr class="odd:bg-gray-100 even:bg-gray-50 odd:dark:bg-gray-900 even:dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-4 py-2 gap-2" style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                                    ...
                                    <form action="{{ route('installment.store') }}" method="POST" style="padding:0;">
                                        @csrf
                                        <input type="hidden" name="name" value="{{ $client->name }}">
                                        <input type="hidden" name="email" value="{{ $client->email }}">
                                        @foreach ($client->services as $service)
                                        ...
                                        @endforeach
                                        <button
                                            class="bg-green-500 text-white py-1 rounded-md hover:bg-green-600"
                                            type="submit">
                                            <svg width="24px" height="24px" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                <g id="SVGRepo_iconCarrier">
                                                    <path d="M16 6H8C6.89543 6 6 6.89543 6 8V16" stroke="#000000" stroke-width="4.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path d="M16 42H8C6.89543 42 6 41.1046 6 40V32" stroke="#000000" stroke-width="4.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path d="M32 42H40C41.1046 42 42 41.1046 42 40V32" stroke="#000000" stroke-width="4.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path d="M32 6H40C41.1046 6 42 6.89543 42 8V16" stroke="#000000" stroke-width="4.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path d="M24 16V32" stroke="#000000" stroke-width="4.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path d="M32 16V32" stroke="#000000" stroke-width="4.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path d="M16 16V32" stroke="#000000" stroke-width="4.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                </g>
                                            </svg>
                                        </button>
                                    </form>

                                    <!-- <form action="{{ route('personnel.destroy', [$client->id, 'client']) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
    ...
    <script>
        ...
        function openReadClientModal(id, name, email, phone, addressHome, services) {
            ...
            document.getElementById('readAddressHome').textContent = addressHome;
        ...
        function openEditClientModal(id, name, email, phone, addressHome) {

            // Set basic client information
            document.getElementById('editName').value = name;
            document.getElementById('editEmail').value = email;
            document.getElementById('editPhone').value = phone;
            document.getElementById('editAddressHome').value = addressHome;
